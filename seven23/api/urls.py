...
from seven23.api.saas.views import StripeSubscriptions, StripeGenerateSession, StripeWebhook
...
if settings.SAAS:
    urlpatterns = urlpatterns + [
        ...
        path(r'v1/stripe/subscriptions', StripeSubscriptions, name='api.stripe.subscriptions'),
    ]